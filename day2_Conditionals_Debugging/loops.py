def main():
    ...
    # Put the \r at the beginning or end of your printed string,
    # e.g. '\rthis string will start at the beginning of the line'. or
    #  'the next string will start at the beginning of the line\r'.
    print(
        "FOR LOOP: have a definite number of iterations. Here the variable declaration, increment and condition are all in one convenient, easy-to-read place.")
    ...
    while True:
        c = input("Please enter your command (q/Q to quit): ")
        if c.lower() == 'q':
            print("Quitting")
            break
        else:
